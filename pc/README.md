...
中文安装
```
sudo curl -o /usr/local/bin/mac.sh https://raw.githubusercontent.com/vruru/warp-selfheal/main/pc/mac.sh && bash mac.sh c
```

英文安装
```
sudo curl -o /usr/local/bin/mac.sh https://raw.githubusercontent.com/vruru/warp-selfheal/main/pc/mac.sh && bash mac.sh e
```
